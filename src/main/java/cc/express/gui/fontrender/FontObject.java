...
import cc.express.gui.fontrender.utils.StringUtils;
...
public class FontObject extends CFont {
    ...
    public FontObject(Font font, boolean antiAlias, boolean fractionalMetrics, double offsetX, double offsetY) {
    ...
    public FontObject(Font font, boolean antiAlias, boolean fractionalMetrics, boolean chinese, double offsetX,
                      double offsetY) {
    ...
    public FontObject(Font font, boolean antiAlias, boolean fractionalMetrics) {
        super(font, antiAlias, fractionalMetrics);
        this.offsetX = 0;
        this.offsetY = 0;
        setupMinecraftColorcodes();
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (character >= 256) {
                try {
                    character = (char) ((int) this.charmap.get(character) + 256);
                } catch (Exception e) {
                }
    ...
    public void drawHVCenteredString(String text, double x, double y, int color) {
        drawString(text, (float) x - getStringWidth(text) / 2, (float) y - FONT_HEIGHT / 2, color, true);
    }


    public void drawVCenteredString(String text, int x, int y, int color) {
        drawString(text, x, y - FONT_HEIGHT / 2, color);
    }

    public void drawVCenteredString(String text, double x, double y, int color) {
        drawString(text, (float) x, (float) y - FONT_HEIGHT / 2, color, true);
    }
}