...
public class CFont {
    public int FONT_HEIGHT = getHeight();
    ...
    public CFont(Font font, boolean antiAlias, boolean fractionalMetrics, boolean texts) {
        this.font = font;
        this.antiAlias = antiAlias;
        this.fractionalMetrics = fractionalMetrics;
        this.texts = texts;
    ...
    protected BufferedImage generateFontImage(Font font, boolean antiAlias, boolean fractionalMetrics,
        ...
        if (this.texts && !hasDone) {
            char[] chinesechar = CharUtils.getChars();
