...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawDefaultBackground();
        FontManager.F18.drawStringWithShadow(GuiAltManager.mc.session.getUsername(), 10.0f, 10.0f, -7829368);
        FontManager.F18.drawCenteredString("Account Manager - " + AltManager.getAlts().size() + " alts", this.width / 2d, 10, -1);
        FontManager.F18.drawCenteredString(this.loginThread == null ? this.status : this.loginThread.getStatus(), this.width / 2d, 20, -1);
        GL11.glPushMatrix();
        ...
        for (Alt alt : AltManager.getAlts()) {
            ...
            FontManager.F18.drawCenteredString(name, this.width / 2f, y - this.offset, -1);
            FontManager.F18.drawCenteredString(pass, this.width / 2f, y - this.offset + 10, 5592405);
            y += 26;
        }
        GL11.glDisable(3089);
        GL11.glPopMatrix();
