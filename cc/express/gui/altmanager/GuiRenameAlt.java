...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        FontManager.F18.drawCenteredString("Edit Alt", this.width / 2f, 10, -1);
        FontManager.F18.drawCenteredString(this.status, this.width / 2f, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            FontManager.F18.drawStringWithShadow("New E-Mail", this.width / 2f - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            FontManager.F18.drawStringWithShadow("New Password", this.width / 2f - 96, 106.0f, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.nameField = new GuiTextField(3, this.mc.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
