...
extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        FontManager.F18.drawCenteredString("Alt Login", this.width / 2f, 20, -1);
        FontManager.F18.drawCenteredString(this.thread == null ? "\u00a7eWaiting..." : this.thread.getStatus(), this.width / 2f, 29, -1);
