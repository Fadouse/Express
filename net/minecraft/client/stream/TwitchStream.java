...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
        ...
        if (this.isBroadcasting() && this.field_152957_i)
        {
            ...
            if (!this.broadcastController.func_152840_a(p_152911_1_.func_152810_c(), i + p_152911_2_, p_152911_1_.func_152809_a(), p_152911_1_.func_152806_b()))
            {
                LOGGER.warn(STREAM_MARKER, "Couldn\'t send stream metadata action at {}: {}",
                		new Object[] {i + p_152911_2_, p_152911_1_});
            }
            else
            {
        ...
        if (this.isBroadcasting() && this.field_152957_i)
        {
            ...
            if (j < 0L)
            {
                LOGGER.warn(STREAM_MARKER, "Could not send stream metadata sequence from {} to {}: {}",
                		new Object[] {i + p_176026_2_, i + p_176026_4_, p_176026_1_});
            }
    ...
    public void func_152930_t()
    {
        ...
        LOGGER.info(STREAM_MARKER, "Streaming at {}/{} at {} kbps to {}",
        		new Object[] {videoparams.outputWidth, videoparams.outputHeight, videoparams.maxKbps, 
        				this.broadcastController.getIngestServer().serverUrl});
